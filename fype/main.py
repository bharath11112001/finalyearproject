    ...
    if request.method == 'POST':
        ...
        if 'image' in request.files:
            ...
            if image and allowed_file(image.filename):
                ...
                image_path = 'E:/fype/static/sign/' + filename
...
def download_document(doc_path):
    ...
    uploads_folder = 'E:/fype/static/uploads/'  # Adjust the folder structure as needed
...
def downloadd(doc_path):
    ...
    uploads_folder = 'E:/fype/static/report/'  # Adjust the folder structure as needed
    return send_from_directory(uploads_folder, doc_path, as_attachment=True)
...
def download_report(review_id):
    try:
        uploads_folder = 'E:/fype/static/report/'
    ...
    if request.method == 'POST':
        ...
        if pdf_files:
            for pdf in pdf_files:  # Iterate through the list of files
                ...
                pdf.save('E:/fype/static/report/' + doc_filename)
...
def abstract():
    ...
    if request.method == 'POST':
        ...
        if doc_file:
            ...
            doc_file.save('E:/fype/static/uploads/' + doc_filename)
            doc_path = (doc_filename)  # Adjust the folder structure as needed
...
def download_pdf(digital_signature_link):
    ...
    uploads_folder = 'E:/fype/static/modified/'  # Adjust the folder structure as needed
...
def download_img():
    ...
    if data1 and data2:
        ...
        try:
            ...
            doc = Document(os.path.join('E:/fype/static/uploads/', document_path))

            # Add the signature image to the Word document
            doc.add_picture(os.path.join('E:/fype/static/sign/', signature_path), width=Inches(2))

            # Save the modified document as a Word document
            modified_folder = 'E:/fype/static/modified/'
...
def view_report(filename):
    ...
    file_path = os.path.join('E:/fype/static/uploads', filename)
    ...
    try:
        ...
        pdf_output_path = os.path.join('E:/fype/static/uploads', f'{filename}.pdf')
